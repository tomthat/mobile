...
class _AddTodoPageState extends State<AddTodoPage> {
  ...
  @override
  void initState() {
    total_thbController.text = "100";
    total_lakController.text = "650000";
    bill_userController.text = "athatsady";
    bill_dateController.text = "2023-10-06";
    super.initState();
    ...
    Future.microtask(() async {
      final response = await BillService.fetchGetRate();
      thb_rateController.text = response?['ccy_amt'].toString() ?? '';
      setState(() {});
    });
  }
